...
4. 無須重啟閱讀器，返回書籍中，點選字體即可見新加入字體「」。<br>
<img src="../Img/Fonts_2.png" width="50%">
...
<img src="../Img/Beta_1.png" width="45%">
3. 關閉「搜尋」後，打開右下角「更多」。<br>
4. 按「體驗版功能」後，可見更多功能出現(下方右圖)，包括數獨等。
<img src="../Img/Beta_2a.png" width="45%"> <img src="../Img/Beta_2b.png" width="45%"><br>
