...
#### 6 首次於PChome購買kobo電子書後，如何連結帳戶以同步書籍至書櫃？<br>
  ...
  官方做法(先買書，後連結帳戶及同步書籍)，坊間亦有先連結帳戶，後買書及同步書籍。目前<b>官方</b>做法或需要<b>登出再登入kobo帳戶</b>(包括App及閱讀器)。而此步驟有機會<b>令kobo帳戶內的「收藏」等數據遺失</b>。請考慮清楚才決定使用PChome買書與否。<br>
  <b>25Jun2022 Update: 有書友指目前使用<b>坊間做法</b>（即先連結PChome後買書），可避免遺失「收藏」等數據，無須登出閱讀器即可開啟書籍。相信Kobo已修復相關數據遺失的問題，不妨一試。<b><br>
  ...
  坊間做法則相反，先在Kobo網頁中到「我的帳戶>帳戶設定」登入選項中找尋PCHome並進行連結。其後再到PChome進行購買即可。<br>
<br>
